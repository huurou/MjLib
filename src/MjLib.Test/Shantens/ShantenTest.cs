...
public class ShantenTest
{
    ...
    public void ForRegularTest()
    {
        ...
        kindList = TileKindList.Parse(man: "1358", pin: "13588", sou: "589", honor: "11");
        Assert.That(Shanten.CalculateForRegular(kindList), Is.EqualTo(3));

        kindList = TileKindList.Parse(man: "1358", pin: "13588", sou: "59", honor: "111");
        Assert.That(Shanten.CalculateForRegular(kindList), Is.EqualTo(3));

        kindList = TileKindList.Parse(man: "1358", pin: "1388", sou: "59", honor: "1111");
        Assert.That(Shanten.CalculateForRegular(kindList), Is.EqualTo(3));
    ...
    {
        var kindList = TileKindList.Parse(man: "567", pin: "11", sou: "1112345678");
    ...
    {
        var kindList = TileKindList.Parse(man: "123456789", honor:"1111");
        Assert.That(Shanten.Calculate(kindList), Is.EqualTo(1));

        kindList = TileKindList.Parse(man: "123456789", pin: "1111");
        Assert.That(Shanten.Calculate(kindList), Is.EqualTo(1));
    }
}