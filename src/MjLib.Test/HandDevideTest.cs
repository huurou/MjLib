...
public class HandDevideTest
{
    ...
    {
        var hand = new TileKindList(man: "234567", sou: "23455", honor: "777");
        ...
        hand = new TileKindList(man: "123", pin: "123", sou: "123", honor: "11222");
    ...
    {
        var hand = new TileKindList(man: "23444", pin: "344556", sou: "333");
        var actual = HandDevider.Devide(hand);
    ...
    {
        var hand = new TileKindList(man: "11122233388899");
        var actual = HandDevider.Devide(hand);
        ...
        hand = new TileKindList(sou: "111123666789", honor: "11");
        actual = HandDevider.Devide(hand);
    ...
    {
        var hand = new TileKindList(pin: "778899", honor: "22");
        var actual = HandDevider.Devide(hand);
    ...
    {
        var hand = new TileKindList(man: "112233", pin: "99", sou: "445566");
        var actual = HandDevider.Devide(hand);
